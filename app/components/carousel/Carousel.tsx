...
// --- Default Data for Alges Jam-e Masjid ---
const defaultSlides: Slide[] = [
  {
    id: 1,
    title: "Alges Jam-e Masjid",
    description: 'A sacred place of worship dedicated to serving the Muslim community through education, spiritual guidance, and community support.',
    image: '/img/waz.jpg',
  ...
  },
  {
    id: 2,
    title: "Quran Classes",
    description: 'Comprehensive Quranic education for all ages - Learn proper recitation (Tajweed), memorization (Hifz), and understanding of the Holy Quran.',
  ...
  },
  {
    ...
    description: 'Deepen your understanding of Islamic teachings, Fiqh, Hadith, and Seerah through our structured educational programs for children and adults.',
  ...
  },
  {
    ...
    description: 'Providing essential support services including food assistance, counseling, youth programs, and social welfare initiatives for our community.',
  ...
  },
  {
    ...
    description: 'Islamic marriage ceremonies (Nikah), pre-marital counseling, and family support services conducted in accordance with Shariah principles.',
